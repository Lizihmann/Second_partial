https://replit.com/join/sihjqhyhwq-liz-sophiesophi
"""
Create a program that allows the user to convert between different units of measurement, 
such as miles to kilometers, liters to gallons, or Fahrenheit to Celsius.
"""

quantity = int(input("Enter the quantity: "))
unit_origin = input("Enter the unit of origin (miles, liters, fahrenheit, etc.): ")
unit_destination = input("Enter the unit of destination (kilometers, gallons, clesius, etc.): ")
